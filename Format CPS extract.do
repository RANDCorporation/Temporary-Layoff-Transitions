...
quietly infix                    ///
  ...
  int     occ           122-125  ///
  int     ind           126-129  ///
  byte    classwkr      130-131  ///
  int     uhrsworkt     132-134  ///
  int     uhrswork1     135-137  ///
  int     uhrswork2     138-140  ///
  int     ahrsworkt     141-143  ///
  int     ahrswork1     144-146  ///
  int     ahrswork2     147-149  ///
  byte    absent        150-150  ///
  byte    durunem2      151-152  ///
  int     durunemp      153-155  ///
  byte    whyunemp      156-156  ///
  byte    whyabsnt      157-158  ///
  int     whyptlwk      159-161  ///
  byte    wkstat        162-163  ///
  int     educ          164-166  ///
  byte    educ99        167-168  ///
  byte    eddipged      169-170  ///
  byte    schlcoll      171-171  ///
  double  lnkfw1mwt     172-185  ///
  double  panlwt        186-195  ///
  double  hourwage      196-200  ///
  byte    paidhour      201-201  ///
  byte    union         202-202  ///
  double  earnweek      203-210  ///
  int     uhrsworkorg   211-213  ///
  byte    wksworkorg    214-215  ///
  byte    eligorg       216-216  ///
  byte    otpay         217-218  ///
  byte    uh_mlr_b3     219-220  ///
  byte    uh_lay6m_b1   221-222  ///
  byte    uh_laydt_b1   223-224  ///
  byte    uh_layoff_b1  225-226  ///
  using `"cps_00039.dat"'
...
label var uh_mlr_b3    `"Monthly labor force recode (formerly esr), 1994-2020_06"'
label var uh_lay6m_b1  `"Recall to work within 6 months, 1994-2020_06"'
label var uh_laydt_b1  `"Return to work date, 1994-2020_06"'
label var uh_layoff_b1 `"On layoff last week, 1994-2020_06"'
...
label define otpay_lbl 01 `"No"'
label define otpay_lbl 02 `"Yes"', add
label define otpay_lbl 99 `"Blank, NIU"', add
label values otpay otpay_lbl

label define uh_mlr_b3_lbl -1 `"Blank"'
label define uh_mlr_b3_lbl 01 `"Employed - at work"', add
label define uh_mlr_b3_lbl 02 `"Employed - absent"', add
label define uh_mlr_b3_lbl 03 `"Unemployed - on layoff"', add
label define uh_mlr_b3_lbl 04 `"Unemployed - looking"', add
label define uh_mlr_b3_lbl 05 `"Not in labor force - retired"', add
label define uh_mlr_b3_lbl 06 `"Not in labor force - disabled"', add
label define uh_mlr_b3_lbl 07 `"Not in labor force - other"', add
label values uh_mlr_b3 uh_mlr_b3_lbl

label define uh_lay6m_b1_lbl -2 `"Don't Know"'
label define uh_lay6m_b1_lbl -1 `"Blank"', add
label define uh_lay6m_b1_lbl 01 `"Yes"', add
label define uh_lay6m_b1_lbl 02 `"No"', add
label values uh_lay6m_b1 uh_lay6m_b1_lbl

label define uh_laydt_b1_lbl -2 `"Don't Know"'
label define uh_laydt_b1_lbl -1 `"Blank"', add
label define uh_laydt_b1_lbl 01 `"Yes"', add
label define uh_laydt_b1_lbl 02 `"No"', add
label values uh_laydt_b1 uh_laydt_b1_lbl

label define uh_layoff_b1_lbl -3 `"Refused"'
label define uh_layoff_b1_lbl -2 `"Don't know"', add
label define uh_layoff_b1_lbl -1 `"Blank"', add
label define uh_layoff_b1_lbl 01 `"Yes"', add
label define uh_layoff_b1_lbl 02 `"No"', add
label define uh_layoff_b1_lbl 03 `"Retired"', add
label define uh_layoff_b1_lbl 04 `"Disabled"', add
label define uh_layoff_b1_lbl 05 `"Unable to work"', add
label values uh_layoff_b1 uh_layoff_b1_lbl

save "cps_00039.dta", replace
